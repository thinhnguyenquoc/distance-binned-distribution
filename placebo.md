...
This document details the scientific rationale, experimental design, and execution protocol for the `Target-Y_D` Placebo Test implemented in `src/experiment/run_unified_placebo.py`.
