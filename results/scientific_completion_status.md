...
| 5 | Partial-OD equivalence v2 | information-equivalence main arm | complete | partial-OD v2 combined summary present | `python src/experiment/run_partial_od_equivalence_v2.py --resume --device cpu` |
| 6 | Direct-OD equivalence v1 | strong comparison arm if needed optional | complete | direct-OD v1 combined summary present (450k calibrations, 50 cities) | `python src/experiment/run_direct_od_equivalence_v1.py --resume --workers 8 --device cpu` |
| 7 | Spatial-resolution summary | summary from existing frozen checkpoints/results | complete | spatial-resolution summary present | `python src/experiment/run_spatial_resolution_experiment.py --device cpu` |
