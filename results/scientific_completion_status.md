...
| 3 | E1-v2 9-donor specificity | highest-priority missing argument | smoke-only | smoke artifact exists; full 50-city canonical specificity output missing | `python src/experiment/run_e1_specificity_from_checkpoints.py --resume --device cpu` |
| 4 | Matched placebo robustness | robustness on canonical checkpoints | missing | matched placebo per-city artifact missing | `python src/experiment/run_placebo_matched_v2.py --b 1000` |
