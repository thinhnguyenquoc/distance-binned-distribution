...
def run_resolution_analysis(
    ...
    n_counties = len(set(pair_county_idx))
    ...
    print("Running City-Level Calibration...")
    ...
    print("Running County-Level Calibration...")
    ...
    print("\n=== RESULTS ===")
    print(f"CPC (Zero-Shot)   : {cpc_0:.4f}")
    print(f"CPC (M_city)      : {cpc_city:.4f}")
    print(f"CPC (M_county)    : {cpc_county:.4f}")
    print(f"Delta (county-city): {cpc_county - cpc_city:.4f}")
...
if __name__ == "__main__":
    ...
    ckpt = f"results/e1/checkpoints/fold{args.fold}_seed2025.pt"
