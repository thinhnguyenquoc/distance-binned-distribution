...
|---|---|---|---|---|
| **Figure 1** | Oracle calibration framework schematic | [`paper/figures/fig1_oracle_calibration_framework.svg`](figures/fig1_oracle_calibration_framework.svg) | Sơ đồ phương pháp luận | Vẽ vector SVG trực tiếp |
