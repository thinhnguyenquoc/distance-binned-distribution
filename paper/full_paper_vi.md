...
Về chất lượng của quan sát, mức tăng CPC trung bình giảm khi nhiễu Total Variation (TV) tăng lên (Hình 5). Mức tăng giảm từ +0.00672 khi không có nhiễu xuống +0.00400 tại 4% TV và +0.00250 tại 5% TV. Đường trung bình vẫn dương trong toàn bộ miền 0–5% TV, nên không xác định được điểm cắt với 0 trong miền khảo sát. Trong 10.000 đường cong bootstrap, chỉ 6 đường có điểm cắt, còn 9.994 đường không cắt và được ghi nhận là kiểm duyệt phải tại giới hạn 5%. Không báo cáo khoảng tin cậy cho vị trí điểm cắt.

Trong năm mức nhiễu dương được khảo sát, 4% TV là mức lớn nhất mà kiểm định Wilcoxon một phía cho giả thuyết lợi ích còn có ý nghĩa sau hiệu chỉnh Holm ($p_{\mathrm{Holm}}=0.00165$). Tại 5% TV, mức tăng trung bình vẫn dương nhưng kiểm định không đạt tiêu chí này ($p_{\mathrm{Holm}}=0.1327$), với 25/50 thành phố cải thiện. Vì vậy, mức 4% TV là kết quả trong lưới khảo sát, không phải ngưỡng bảo đảm hiệu quả áp dụng.

![Hình 5](figures_interzonal/fig5_noise_dose_response.png)
**Hình 5. Mức thay đổi CPC trung bình theo mức nhiễu Total Variation thêm vào phân phối mục tiêu.** Các điểm biểu diễn mức thay đổi CPC trung bình trên 50 thành phố, còn dải bóng mờ biểu diễn khoảng tin cậy bootstrap 95% phân tầng theo fold. Đường trung bình vẫn nằm trên 0 trong toàn bộ miền nhiễu 0–5% TV.

Trong các cấu hình oracle được khảo sát, tăng số nhóm khoảng cách giúp tăng mức cải thiện trung bình. Nhiễu làm lợi ích suy giảm, mặc dù mức tăng trung bình vẫn dương trong miền nhiễu đã đánh giá.
...
CPC trước hiệu chỉnh của GNN và MLP lần lượt là 0.69498 và 0.69834, trong khi Gravity hai tham số đạt 0.38868. Mặc dù MLP có CPC ban đầu cao hơn về mặt mô tả, GNN có mức tăng sau hiệu chỉnh lớn hơn. Cả hai mô hình neural đều cải thiện ở phần lớn thành phố (49/50 và 48/50). Ngược lại, Gravity chỉ có mức tăng khiêm tốn $+0.00083$ và chỉ cải thiện ở 22/50 thành phố (Wilcoxon $p=0.709$), cho thấy hiệu quả của phép hiệu chỉnh tỷ lệ phân phối khoảng cách phụ thuộc đáng kể vào độ chính xác và khả năng biểu đạt của mô hình dự báo ban đầu.
