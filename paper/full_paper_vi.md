...
Nghiên cứu áp dụng quy trình kiểm định chéo liên thành phố 5 lượt (5-fold cross-validation) trên 50 thành phố ở Hoa Kỳ. Kết quả thực nghiệm cho thấy hiệu chỉnh ở cấp thành phố làm CPC trung bình tăng từ mức nền $0.71281$ lên $0.71635$ (tức $\Delta\mathrm{CPC} = +0.00354$, tăng tương đối $\sim 0.5\%$; CI 95%: $[+0.0026, +0.0045]$, $p = 1.93 \times 10^{-9}$), với 45/50 thành phố được cải thiện. Các đối chứng giả dược chuẩn hóa liều can thiệp (dose-matched placebo controls) khẳng định tính đặc hiệu cấu trúc: phân phối từ thành phố khác hoặc phân phối bị hoán vị ngẫu nhiên đều làm triệt tiêu hoàn toàn lợi ích ($\Delta\mathrm{CPC} \le 0$), chứng minh mức cải thiện phụ thuộc chặt chẽ vào phân phối thực của chính thành phố mục tiêu. Mức cải thiện giảm dần khi phân phối quan sát có độ phân giải thấp hơn hoặc bị suy thoái bởi nhiễu. Tuy nhiên, các kết luận này giới hạn nghiêm ngặt ở bài toán tái tạo cường độ luồng với phân phối oracle trên tập hỗ trợ liên vùng đã biết, chưa đánh giá việc phát hiện liên kết mới hay khả năng triển khai với nguồn quan sát thu thập độc lập.
...
Nghiên cứu áp dụng quy trình kiểm định chéo liên thành phố 5 lượt (5-fold cross-validation) trên 50 vùng đô thị tại Hoa Kỳ để định lượng mức cải thiện và xác định các điều kiện quan sát ảnh hưởng đến mức cải thiện đó. Đồng thời, các thí nghiệm với nhiều khởi tạo ngẫu nhiên và kiến trúc mô hình được sử dụng để kiểm tra tính ổn định của kết quả. Qua đó, nghiên cứu làm rõ phân phối di chuyển theo khoảng cách của thành phố mục tiêu có thể bổ sung bao nhiêu cho dự báo zero-shot và trong những điều kiện nào thông tin này có ích.
...
Ngoài ra, về mặt so sánh phương pháp, một câu hỏi tự nhiên từ các phương pháp cổ điển như Hyman [@hyman1969calibration] hay Merlin [@merlin2020medians] là liệu có thể chỉ dùng $Y_D$ để ước lượng lại một tham số suy giảm khoảng cách duy nhất $\alpha$ của mô hình Gravity hay không. Trong nghiên cứu này, việc hiệu chỉnh trực tiếp theo từng bin ($K=8$) cung cấp khả năng điều chỉnh phi tham số cục bộ trên toàn dải cự ly, vượt trội so với việc chỉ xoay chuyển độ dốc hàm mũ/lũy thừa đơn biến của tham số $\alpha$. Kết quả ở Bảng 5 cho thấy ngay cả khi áp dụng toán tử phân nhóm linh hoạt cho Gravity hai tham số, mức tăng CPC chỉ đạt $+0.00084$ (thắng 22/50 thành phố), thấp hơn rõ rệt so với mức tăng trên các mạng neural ($+0.00354$ trên Urban GNN và $+0.00329$ trên Node MLP). Điều này khẳng định giá trị cốt lõi của $Y_D$ phát huy tối đa khi kết hợp phân phối khoảng cách đa nhóm với các biểu diễn phi tuyến sâu giàu ngữ cảnh đô thị, thay vì chỉ tối ưu lại một tham số hàm suy giảm đơn lẻ.
...
Nghiên cứu này cho thấy phân phối di chuyển theo khoảng cách của thành phố mục tiêu có thể cung cấp thông tin bổ sung để cải thiện dự báo của mô hình zero-shot được giữ cố định. Trong thiết lập oracle trên 50 thành phố Hoa Kỳ, hiệu chỉnh với Urban GNN làm CPC tăng trung bình +0.00354, với 45/50 thành phố được cải thiện. Kết quả cho thấy, dù mô hình đã khai thác đặc điểm đô thị và khoảng cách địa lý, phân phối di chuyển theo khoảng cách của chính thành phố mục tiêu vẫn giúp cải thiện nhẹ nhưng nhất quán ở phần lớn thành phố được đánh giá.

Tuy nhiên, mức cải thiện phụ thuộc vào độ phân giải và chất lượng của phân phối quan sát. Trong dải khảo sát, tăng số nhóm khoảng cách giúp tăng mức cải thiện trung bình, còn nhiễu làm lợi ích suy giảm. Các đối chứng cũng cho thấy việc sử dụng phân phối của đúng thành phố và giữ đúng sự tương ứng giữa tỷ trọng lưu lượng với các nhóm khoảng cách có ý nghĩa đối với hiệu quả hiệu chỉnh. Các kết luận này giới hạn ở việc tái tạo cường độ luồng trên tập hỗ trợ liên vùng dương đã biết với phân phối oracle. Việc đánh giá phân phối được thu thập độc lập là bước tiếp theo để kiểm chứng khả năng áp dụng trong thực tế.
