...
Các đối chứng cho thấy việc cung cấp một phân phối tổng hợp bất kỳ không mang lại lợi ích tương đương với phân phối của thành phố mục tiêu. Khi độ lớn can thiệp được ghép theo RMS log-ratio, sự tương ứng giữa tín hiệu hiệu chỉnh và các nhóm khoảng cách vẫn có liên quan đến kết quả. Vì vậy, giá trị của quan sát phụ thuộc vào nội dung thông tin mà nó cung cấp, bên cạnh độ lớn của phép điều chỉnh.
